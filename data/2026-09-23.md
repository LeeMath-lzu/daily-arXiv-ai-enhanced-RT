...
### [1] [Dunkl theory, convolution algebras, and related Markov processes](https://arxiv.org/abs/2609.26394)
...
### [2] [Littlewood-Paley theory for orthogonal expansions associated with root systems](https://arxiv.org/abs/2609.12722)
...
### [3] [Uniform bounds on the Dunkl kernel](https://arxiv.org/abs/2607.02176)
*Lukas Langen*
...
### [4] [Crepant partial resolutions of the nilpotent cone via Hamiltonian reduction](https://arxiv.org/abs/2608.25994)
...
### [5] [Border rank lower bounds for families of GL(V)-invariant tensors](https://arxiv.org/abs/2508.17845)
*Suhas Vadan Gondi*
...
### [6] [Generalized Goulden-Yong duals and signed minimal factorizations](https://arxiv.org/abs/2311.05732)
...
Abstract: In this paper, we give two combinatorial ways to study signed exceptional sequences. First, we show the equivalence between one-way reflections and relatively projective representations. Secondly, we construct generalized Goulden-Yong duals using reverse Garside element actions and folded chord diagrams. We then give two applications of the generalized Goulden-Yong duals: constructing generalized Prüfer codes and counting signed factorizations using the matrix-tree theorem.
...
### [7] [A graph planar algebra approach to near-group categories](https://arxiv.org/abs/2609.26684)
...
### [8] [Categorification of quasi-split iquantum groups](https://arxiv.org/abs/2505.22929)
...
### [9] [Multiplicity One Property for Archimedean Theta Correspondence](https://arxiv.org/abs/2609.26630)
...
### [10] [Representation-tame Geiß-Leclerc-Schröer algebras and a revised GLS conjecture on root systems](https://arxiv.org/abs/2609.26503)
...
### [11] [Brauer webs of finite and affine type](https://arxiv.org/abs/2609.26498)
...
### [12] [The Brauer $A(\infty)$ condition and Navarro's conjecture on Brauer characters under coprime actions](https://arxiv.org/abs/2609.26441)
...
### [13] [Slash indecomposability of Endopermutation Scott modules](https://arxiv.org/abs/2609.25967)
*Lin Wu*
...
### [14] [Graded Representation Theory of Equivariant Neural Networks](https://arxiv.org/abs/2609.25776)
*Mani Shayestehfar*
...
### [15] [On the Twisted Group Ring Isomorphism Problem for isoclinic groups](https://arxiv.org/abs/2609.25718)
...
### [16] [Exact dg structures are classified intrinsically by bi-Serre subcategories](https://arxiv.org/abs/2609.25583)
*Yasuaki Ogawa*
...
### [17] [Frobenius functors and $n$-torsionfree objects](https://arxiv.org/abs/2609.25539)
*Zhibing Zhao*
...
### [18] [Indecomposable characters of the wreath product of a torus by the infinite block-diagonal symmetric group](https://arxiv.org/abs/2609.25275)
...
### [19] [A geometric realization of socle-projective categories for posets of type $\mathbb{D}$](https://arxiv.org/abs/2609.25174)
...
### [20] [Monoidal Gröbner systems and categories of affine Brauer type](https://arxiv.org/abs/2609.25159)
...
### [21] [Categorical representations of algebraic groups in positive characteristic](https://arxiv.org/abs/2609.25148)
...
### [22] [An irreducible decomposition of the Weil representation restricted to open compact subgroups](https://arxiv.org/abs/2609.25045)
*Yuta Takahashi*
...
### [23] [Virasoro extensions of generalized Kac-Moody algebras](https://arxiv.org/abs/2609.15729)
*Vladyslav Zveryk*
...
### [24] [On the absolute convergence of the spectral side of the twisted trace formula](https://arxiv.org/abs/2607.18870)
...
### [25] [Spectral Intertwining Operators](https://arxiv.org/abs/2606.17560)
*Qiyuan Chen*
...
### [26] [Kernel of Scott modules and Brauer indecomposability](https://arxiv.org/abs/2605.05757)
*Lin Wu*
...
### [27] [Quiver presentations for band algebras are defined over the integers](https://arxiv.org/abs/2601.06587)
*Benjamin Steinberg*
...
### [28] [Kostant $ρ$-decomposition of homology I. Finite-dimensional representations](https://arxiv.org/abs/2510.01343)
...
Abstract: We give explicit, uniform formulas for the graded characters and total ranks of the Lie algebra homology of finite-dimensional representations in all classical types. In many cases, these compute the Tor groups of finite length modules over polynomial rings, and this is the first in a series of papers to investigate total rank conjectures from this perspective. These formulas refine and generalize the classical $ρ$-decomposition of Kostant, and in particular we prove that the characters involved exhibit three structural phenomena: divisibility (by a large power of 2), equidistribution, and uniform factorization formulas.

</details>


### [29] [Skein algebras and quantized Coulomb branches](https://arxiv.org/abs/2401.06737)
...
### [30] [On singular supports of Lusztig's perverse sheaves](https://arxiv.org/abs/2401.02770)
*Jiepeng Fang*
...
### [31] [Geometric Complexity Theory and Graph Isomorphism](https://arxiv.org/abs/2606.26244)
...
Abstract: We investigate ideas from the Geometric Complexity Theory approach to separating complexity classes (Mulmuley & Sohoni, SIAM J. Comput., 2001) in the setting of graph isomorphism. This provides us a playground of finite combinatorial objects on which to explore these techniques. We seek to separate non-isomorphic pairs of graphs using vector spaces of polynomials that are set-wise invariant under permutations (so-called separating modules). We characterize the power of this method for distinguishing graphs under several different complexity measures:
  - We show that separating modules of "support-degree" $k$ are equivalent in power to the counts of $O(k)$-vertex subgraphs.
  - We show that separating modules of symmetric algebraic circuit size $n^{Θ(k)}$ are equivalent to $Θ(k)$-dimensional Weisfeiler-Leman. This generalizes and strengthens the result of Dawar & Wilsenach (CSL '18; ICALP '20; ACM Trans. Comput. Log., 2022; Theory Comput., 2025).
  - When considering only the representation-theoretic multiplicities of separating modules, we show that two graphs are separated by multiplicities if and only if their automorphism groups have different multiplicity of cycle types (cycle index).
...
### [32] [Free Immersions in Critical Dimension from Lie Groups](https://arxiv.org/abs/2609.24777)
...
### [33] [Finite images of braid group representations and algebraic solutions of KZ-type equations](https://arxiv.org/abs/2609.25805)
*Haru Negami*
...
### [34] [Refining invariants of finite groups with class functions](https://arxiv.org/abs/2609.26464)
